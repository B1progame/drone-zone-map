...
export async function getOfflineWorldPack(){return(await getOfflinePacks()).find(pack=>pack.metadata.version>=7&&Boolean(pack.generation)&&Boolean(pack.metadata.tileCount))}
